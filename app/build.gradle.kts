...
dependencies {
    ...
    // Remove individual versioned firebase-auth to avoid conflict with BOM
...
// For ActivityResultLauncher to handle camera/gallery
    ...
    implementation("com.google.firebase:firebase-auth-ktx") // Add auth via BOM if you need auth
}